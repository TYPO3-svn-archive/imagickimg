...
class ux_ElementInformationController extends \TYPO3\CMS\Backend\Controller\ContentElement\ElementInformationController {
	...
	public function renderFileInfo($returnLinkTag) {
		...
		if (\TYPO3\CMS\Core\Utility\GeneralUtility::inList($GLOBALS['TYPO3_CONF_VARS']['GFX']['imagefile_ext'], $fileExtension)) {
			...
			if (TYPO3_DLOG)
				\TYPO3\CMS\Core\Utility\GeneralUtility::devLog(__METHOD__ . 'Got image info', $this->extKey, -1, $imgInfo);
